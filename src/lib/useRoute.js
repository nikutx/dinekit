...
const VALID_VIEWS = [ 'home', 'reports', 'builder', 'design', 'qr', 'orders', 'pos', 'hours', 'bookings', 'floor', 'events', 'guests', 'reviews', 'staff', 'integrations', 'emails', 'access', 'activity', 'settings' ];
